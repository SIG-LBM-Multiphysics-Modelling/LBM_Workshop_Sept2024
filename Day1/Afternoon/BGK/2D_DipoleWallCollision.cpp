...
const double U_ref = 0.01, Scale_velocity = 1./U_ref, Scale_time = Scale_length/Scale_velocity, Scale_vorticity = 1./Scale_time, we = we_phys/Scale_vorticity;
